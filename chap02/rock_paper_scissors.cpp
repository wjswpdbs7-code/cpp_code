...
string rock_paper_scissors(const string str1, const string str2){
    ...
    for(string s : {"가위", "바위", "보"}){
        if(str1 == s && str2 == s)//&&은 논리곱 연산자로, 두 조건이 모두 참일 때 전체 조건이 참이 됩니다. 여기서는 str1과 str2가 모두 같은 값을 가지고 있는지를 확인하는 역할을 합니다. 예를 들어, str1이 "가위"이고 str2도 "가위"인 경우, str1 == s && str2 == s 조건이 참이 되어 "비겼습니다."라는 결과가 반환됩니다. 따라서 이 부분은 두 플레이어가 같은 선택을 했을 때 비긴 상황을 처리하는 역할을 합니다.
            return "비겼습니다.";
    }
